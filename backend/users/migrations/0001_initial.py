    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_researcher', models.BooleanField(default=False, help_text='Designates whether the user can access researcher portal')),
                ('is_instructor', models.BooleanField(default=False, help_text='Designates whether the user can access the instructor portal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surveys', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), blank=True, default=list, size=None)),
